...
🌐 **Portfolio:** [roy3177.github.io/My-site](https://roy3177.github.io/My-site)
...
AI-powered platform that transforms complex medical documents into multilingual, patient-friendly explanations using LLMs, document intelligence, and Text-to-Speech — built for Israel's diverse population.
...
> **4-Agent AI Recruitment Pipeline — Live in Production**

Triage → Parser → Analyst → Team Lead. Fully automated multi-agent system that screens CVs against job descriptions and delivers scored, reasoned hiring recommendations.
...
Ingests PDFs, Markdown & Slack into a vector database. Semantic search via pgvector. Exposes an **MCP server** so any AI agent can plug in and query the knowledge base directly.
